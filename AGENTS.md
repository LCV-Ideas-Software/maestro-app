# AGENTS.md - maestro-app

Pointer for AI agents working in this repository.

## Project

- Repository: `https://github.com/LCV-Ideas-Software/maestro-app`
- App: Maestro Editorial AI — bancada editorial Windows para redacao assistida e convergencia multi-agente
- Branch: `main`
...
Quadro deste repositorio: `https://github.com/orgs/LCV-Ideas-Software/projects/14`
...
`gh api graphql -f query='query{organization(login:"LCV-Ideas-Software"){projectV2(number:14){id}}}'`.
